...
public abstract class DailyHotelRequest<T> extends Request<T> implements Constants
{
	...
	//		String test = null;
	//
	//		test = DailyHotelRequest.getUrlEncoder("http://lb.dailyhotel.kr/");

	//	
	//			test = DailyHotelRequest.getUrlEncoder("api/reserv/session/easy_payment");
	//		test = DailyHotelRequest.getUrlEncoder("api/reserv/session/common_payment");
	...
	//
	//		test = DailyHotelRequest.getUrlEncoder("api/user/session/billing/card/info");
	//		test = DailyHotelRequest.getUrlEncoder("api/user/session/billing/card/del");
	//		
	//				
	//				test = DailyHotelRequest.getUrlEncoder("api/reserv/saleDetailInfo");
	//	
	...
	//	test = DailyHotelRequest.getUrlEncoder("api/common/time");
