...
public class HotelListAdapter extends ArrayAdapter<HotelListElement>{
	...
	public HotelListAdapter(Context context, int resourceId, ArrayList<HotelListElement> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		HotelListElement element = items.get(position);
