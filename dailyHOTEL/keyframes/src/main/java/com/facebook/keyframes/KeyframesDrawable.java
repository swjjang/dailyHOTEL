  ...
  private class FeatureState {
    ...
    private void prepareShadersForFeature(KFFeature feature) {
      ...
      for (int i = 0; i < precision; i++) {
        ...
        if(gradient.gradientPosition0 != null && gradient.gradientPosition1 != null)
        {
          mCachedShaders[i] = new LinearGradient(
              gradient.gradientPosition0[0],
              gradient.gradientPosition0[1],
              gradient.gradientPosition1[0],
              gradient.gradientPosition1[1],
