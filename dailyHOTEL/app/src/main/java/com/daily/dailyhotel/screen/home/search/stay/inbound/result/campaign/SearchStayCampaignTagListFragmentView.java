 ...
 * Clean Architecture
 */
public class SearchStayCampaignTagListFragmentView extends BaseBlurFragmentView<SearchStayCampaignTagListFragmentInterface.OnEventListener, FragmentStayListDataBinding>//
    implements SearchStayCampaignTagListFragmentInterface.ViewInterface
{
    ...
    public void setWish(int position, boolean wish)
    {
        ...
        getViewDataBinding().recyclerView.post(new Runnable()
        {
            ...
            public void run()
            {
                SearchStayCampaignTagListAdapter.StayViewHolder stayViewHolder = (SearchStayCampaignTagListAdapter.StayViewHolder) getViewDataBinding().recyclerView.findViewHolderForAdapterPosition(position);
