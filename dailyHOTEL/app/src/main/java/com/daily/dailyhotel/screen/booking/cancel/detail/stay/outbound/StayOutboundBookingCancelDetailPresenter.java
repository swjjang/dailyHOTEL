    ...
    implements StayOutboundBookingCancelDetailView.OnEventListener
{
    ...
    public void constructorInitialize(StayOutboundBookingCancelDetailActivity activity)
    {
        ...
        setAnalytics(new StayOutboundBookingCancelDetailCancelAnalyticsImpl());
    ...
    {
        mAnalytics = (StayOutboundBookingCancelAnalyticsInterface) analytics;
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        switch (requestCode)
        {
            ...
            case StayOutboundBookingCancelDetailActivity.REQUEST_CODE_REFUND:
