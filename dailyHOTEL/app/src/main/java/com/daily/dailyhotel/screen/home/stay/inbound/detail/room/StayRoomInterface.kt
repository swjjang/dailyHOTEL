...
interface StayRoomInterface {
    ...
    interface AnalyticsInterface : BaseAnalyticsInterface {
        fun onScreen(activity: StayRoomActivity)

        fun onScrolled(activity: StayRoomActivity, stayIndex: Int, roomIndex: Int)

        fun onBookingClick(activity: StayRoomActivity, stayIndex: Int, roomIndex: Int)
    }
}
