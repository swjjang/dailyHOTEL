...
import com.twoheart.dailyhotel.databinding.LayoutStayOutboundBookingCancelDetailDataBinding;
    ...
    implements StayOutboundBookingCancelDetailInterface, View.OnClickListener
{
    ...
    private LayoutStayOutboundBookingCancelDetailDataBinding mBookingCancelDetailDataBinding;
    ...
    protected void setContentView(final ActivityStayOutboundBookingCancelDetailDataBinding viewDataBinding)
    {
        ...
        mBookingCancelDetailDataBinding = DataBindingUtil.inflate(LayoutInflater.from(getContext()) //
            , R.layout.layout_stay_outbound_booking_cancel_detail_data, viewDataBinding.detailsLayout, true);
    ...
    private void setCancelInformation(Context context, LayoutStayOutboundBookingCancelDetailDataBinding dataBinding, StayOutboundBookingDetail stayOutboundBookingDetail)
    {
        if (context == null || dataBinding == null || stayOutboundBookingDetail == null)
        {
            return;
