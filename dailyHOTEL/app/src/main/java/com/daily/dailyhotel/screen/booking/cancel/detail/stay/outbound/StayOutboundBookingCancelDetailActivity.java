...
//    static final int REQUEST_CODE_ISSUING_RECEIPT = 10000;
    ...
    {
        Intent intent = new Intent(context, StayOutboundBookingCancelDetailActivity.class);
    ...
    @NonNull
    @Override
    protected StayOutboundBookingCancelDetailPresenter createInstancePresenter()
    {
        return new StayOutboundBookingCancelDetailPresenter(this);
    }
