...
public class GourmetClusterRenderer extends DefaultClusterRenderer<GourmetClusterItem>
{
    private Context mContext;
    private GourmetClusterItem mClusterItem;
    ...
    public GourmetClusterRenderer(Context context, GoogleMap map, ClusterManager<GourmetClusterItem> clusterManager)
    {
    ...
    @Override
    protected void onBeforeClusterItemRendered(GourmetClusterItem clusterItem, MarkerOptions markerOptions)
    {
        ...
        PlaceRenderer placeRenderer = new PlaceRenderer(mContext, gourmet.discountPrice, R.drawable.bg_hotel_price_special1);
    ...
    @Override
    protected void onBeforeClusterRendered(Cluster<GourmetClusterItem> cluster, MarkerOptions markerOptions)
    {
    ...
    @Override
    protected void onClusterItemRendered(GourmetClusterItem clusterItem, Marker marker)
    {
    ...
    @Override
    protected boolean shouldRenderAsCluster(Cluster<GourmetClusterItem> cluster, float zoom)
    {
        return (Float.compare(zoom, 13.0f) < 0);
    }

    public void setSelectedClusterItem(GourmetClusterItem placeClusterItem)
    {
