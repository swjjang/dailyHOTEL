...
import com.twoheart.dailyhotel.databinding.ViewSearchStayOutboundFilterDataBinding;

import io.reactivex.Completable;
import io.reactivex.CompletableObserver;

public class SearchStayOutboundFilterView extends ConstraintLayout implements View.OnClickListener
{
    private ViewSearchStayOutboundFilterDataBinding mViewDataBinding;
    ...
    public SearchStayOutboundFilterView(Context context)
    {
        super(context);
    ...
    public SearchStayOutboundFilterView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public SearchStayOutboundFilterView(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    {
        mViewDataBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.view_search_stay_outbound_filter_data, this, true);
        ...
        mViewDataBinding.peopleBackgroundView.setOnClickListener(this);
        mViewDataBinding.searchTextView.setOnClickListener(this);
    }

    public void setOnFilterListener(OnStayOutboundFilterListener listener)
    {
    ...
    public void setPeopleText(CharSequence text)
    {
        if (mViewDataBinding == null)
        {
            return;
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            case R.id.peopleBackgroundView:
                mFilterListener.onPeopleClick();
                break;
