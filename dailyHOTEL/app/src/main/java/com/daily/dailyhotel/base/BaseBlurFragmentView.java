...
public abstract class BaseBlurFragmentView<T1 extends OnBaseEventListener, T2 extends ViewDataBinding> extends BaseFragmentDialogView<T1, T2> implements BaseBlurFragmentViewInterface
{
    ImageView mBlurImageView;

    public BaseBlurFragmentView(T1 listener)
    {
        super(listener);
    }
