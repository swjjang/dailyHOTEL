...
public class RewardHistoryPresenter extends BaseExceptionPresenter<RewardHistoryActivity, RewardHistoryInterface> implements RewardHistoryView.OnEventListener
{
    ...
    void notifyStickerValidityChanged()
    {
        ...
        try
        {
            getViewInterface().setStickerValidityText(getString(R.string.label_reward_sticker_validity, DailyCalendar.convertDateFormatString(mStickerValidity, DailyCalendar.ISO_8601_FORMAT, "yyyy.MM.dd HH:mm")));
