    ...
    , ClusterManager.OnClusterClickListener<StayOutboundClusterItem>, ClusterManager.OnClusterItemClickListener<StayOutboundClusterItem>
{
    ...
    public void setStayOutboundList(List<StayOutbound> stayOutboundList)
    {
        ...
        makeMarker(true, stayOutboundList, (StayOutbound) mSelectedMarker.getTag());
    }
...
//        mClusterManager.getMarkerCollection()
    ...
    private void makeMarker(boolean refreshAll, List<StayOutbound> stayOutboundList, StayOutbound selectedStayOutbound)
    {
    ...
    private void onMarkerClick(Context context, StayOutboundClusterItem stayOutboundClusterItem, Marker marker)
    {
        ...
        PlaceRenderer placeRenderer = new PlaceRenderer(context, stayOutboundClusterItem.getStayOutbound().nightlyRateKrw, R.drawable.bg_hotel_price_special1);
