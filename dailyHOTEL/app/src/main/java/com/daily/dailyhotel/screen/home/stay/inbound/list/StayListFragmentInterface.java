 ...
 * Clean Architecture
 */
public interface StayListFragmentInterface
{
    ...
    interface AnalyticsInterface extends BaseAnalyticsInterface
    {
        ...
        void onEventWishClick(Activity activity, DailyCategoryType categoryType, int stayIndex, boolean wish, boolean isListViewType);
