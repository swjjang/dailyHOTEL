...
public class SearchStayResultTabActivity extends BaseActivity<SearchStayResultTabPresenter>
{
    ...
    public static final String INTENT_EXTRA_DATA_CHECK_IN_DATE_TIME = "visitDateTime";
    public static final String INTENT_EXTRA_DATA_CHECK_OUT_DATE_TIME = "visitDateTime";
    ...
    public static Intent newInstance(Context context, String checkInDateTime, String checkOutDateTime, StaySuggestV2 suggest, String inputKeyWord)
    {
