...
{
    private DailyViewGourmetMapCardDataBinding mViewDataBinding;

    public DailyGourmetMapCardView(Context context)
    {
        super(context);
    ...
    public DailyGourmetMapCardView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public DailyGourmetMapCardView(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    {
        mViewDataBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.daily_view_gourmet_map_card_data, this, true);
    ...
    public void setNameText(String stayName)
    {
        if (mViewDataBinding == null)
        {
            return;
    ...
    public void setPriceText(int discountPercent, int discountPrice, int price, String couponPrice)
    {
        if (mViewDataBinding == null)
        {
            return;
