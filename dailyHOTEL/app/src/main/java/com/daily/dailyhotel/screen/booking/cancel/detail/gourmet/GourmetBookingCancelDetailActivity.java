 ...
 * Clean Architecture
 */
public class GourmetBookingCancelDetailActivity extends BaseActivity<GourmetBookingCancelDetailPresenter>
{
    ...
    {
        Intent intent = new Intent(context, GourmetBookingCancelDetailActivity.class);
    ...
    @NonNull
    @Override
    protected GourmetBookingCancelDetailPresenter createInstancePresenter()
    {
        return new GourmetBookingCancelDetailPresenter(this);
    }
