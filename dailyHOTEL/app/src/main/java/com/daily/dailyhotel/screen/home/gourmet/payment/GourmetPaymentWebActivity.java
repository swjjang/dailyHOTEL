...
{
    private String URL_WEBAPI_PAYMENT = Constants.UNENCRYPTED_URL ? "api/v4/booking/gourmet/{type}"//
    ...
    {
        Intent intent = new Intent(context, GourmetPaymentWebActivity.class);
