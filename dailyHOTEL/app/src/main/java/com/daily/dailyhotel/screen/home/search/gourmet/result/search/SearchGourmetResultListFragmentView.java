 ...
 * Clean Architecture
 */
public class SearchGourmetResultListFragmentView extends BaseBlurFragmentView<SearchGourmetResultListFragmentInterface.OnEventListener, FragmentStayListDataBinding>//
    implements SearchGourmetResultListFragmentInterface.ViewInterface
{
    ...
    SearchGourmetResultListAdapter mStayListAdapter;
    ...
    public void setList(List<ObjectItem> objectItemList, boolean isSortByDistance, boolean nightsEnabled, boolean rewardEnabled, boolean supportTrueVR)
    {
        ...
        {
            mStayListAdapter = new SearchGourmetResultListAdapter(getContext(), null);
    ...
    public void setWish(int position, boolean wish)
    {
        ...
        getViewDataBinding().recyclerView.post(new Runnable()
        {
            ...
            public void run()
            {
                SearchGourmetResultListAdapter.StayViewHolder stayViewHolder = (SearchGourmetResultListAdapter.StayViewHolder) getViewDataBinding().recyclerView.findViewHolderForAdapterPosition(position);
