...
public class AnalyticsManager
{
    ...
    public static class Screen
    {
        ...
        public static final String DAILY_GOURMET_UNAVAILABLE_COUPON_LIST = "DailyGourmet_UnavailableCouponList";
    ...
    public static class Label
    {
        ...
        public static final String SORTFILTER_BREAKFAST = "Breakfast";
        public static final String SORTFILTER_SPA_WALL_POOL = "SpaWallpool";
        ...
        public static final String SORTFILTER_CAFETERIA = "Cafeteria";
        public static final String SORTFILTER_TOOTHBRUSH_SET = "ToothbrushSet";
        public static final String SORTFILTER_POOL = "Pool";
        public static final String SORTFILTER_FITNESS = "Fitness";
        public static final String SORTFILTER_SHARED_BBQ = "SharedBbq";
        public static final String SORTFILTER_PICK_UP = "PickupAvailable";
        public static final String SORTFILTER_CONVENIENCE_STORE = "ConvenienceStore";
        ...
        public static final String SORTFILTER_CLUB_LOUNGE = "ClubLounge";
        public static final String SORTFILTER_SAUNA = "Sauna";
        public static final String SORTFILTER_SEMINAR_ROOM = "SeminarRoom";
        public static final String SORTFILTER_PC = "Pc";
        public static final String SORTFILTER_SHOWER_GOWN = "ShowerGown";
        ...
        public static final String _GOURMET_LIST = "GourmetList"; // Old Ver 로 앞에 _ 삽입
    ...
    public static class KeyType
    {
        ...
        public static final String BEDTYPE_DOUBLE = "bedtype_double";
        public static final String BEDTYPE_TWIN = "bedtype_twin";
        public static final String BEDTYPE_IN_FLOOR_HEATING = "bedtype_in_floor_heating";
        public static final String BEDTYPE_SINGLE = "bedtype_single";
        public static final String FACILITY_KIDS_PLAY_ROOM = "facility_kids_play_room";
        public static final String FACILITY_POOL = "facility_pool";
        public static final String FACILITY_PET = "facility_pet";
        public static final String FACILITY_BREAKFAST = "facility_breakfast";
        public static final String FACILITY_PART_ROOM = "facility_part_room";
        public static final String FACILITY_WHIRLPOOL = "facility_whirlpool";
    }
