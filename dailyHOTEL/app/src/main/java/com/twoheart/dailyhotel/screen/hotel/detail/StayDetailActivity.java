...
public class StayDetailActivity extends PlaceDetailActivity
{
    ...
    {
        startActivityForResult(HappyTalkCategoryDialog.newInstance(this, HappyTalkCategoryDialog.SCREEN_STAY_DETAIL, ((StayDetail) mPlaceDetail).getStayDetailParams().index, 0), Constants.CODE_REQUEST_ACTIVITY_HAPPY_TALK);
        //
        //        try
        //        {
    ...
    void processBooking(SaleTime saleTime, StayDetail stayDetail, StayProduct stayProduct)
    {
        ...
        Intent intent = HotelPaymentActivity.newInstance(StayDetailActivity.this, stayProduct//
            ...
            , stayDetailParams.isOverseas, stayDetailParams.name, stayDetailParams.category, stayDetail.nights);
