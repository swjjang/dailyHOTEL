...
public class ProfileNetworkController extends BaseNetworkController
{
    ...
    {
        void onUserInformation(String sns, String email, String name, String phone);
    }
    ...
    private DailyHotelJsonResponseListener mUserLogInfoJsonResponseListener = new DailyHotelJsonResponseListener()
    {
        ...
        public void onResponse(String url, JSONObject response)
        {
            try
            {
                ...
                ((OnNetworkControllerListener) mOnNetworkControllerListener).onUserInformation(null, email, name, phone);
            } catch (Exception e)
            {
