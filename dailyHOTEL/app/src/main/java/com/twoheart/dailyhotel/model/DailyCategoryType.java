...
{
    // 기존 버튼 용 카테고리
    STAY_ALL(R.string.label_home_category_stay_all, R.string.code_home_category_all, 0),
    // 기존 버튼 용 카테고리
    GOURMET_ALL(0, 0, 0),
    // 신규 홈 카테고리 버튼 용 카테고리
    ...
    STAY_NEARBY(R.string.label_home_category_stay_nearby, R.string.code_home_category_nearby, R.drawable.vector_home_shortcut_nearby),
