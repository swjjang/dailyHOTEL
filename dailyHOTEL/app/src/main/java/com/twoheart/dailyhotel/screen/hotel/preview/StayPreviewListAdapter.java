...
public class StayPreviewListAdapter extends BaseAdapter
{
    ...
    StayPreviewLayout.OnEventListener mOnEventListener;
    private View.OnTouchListener mEmptyViewOnTouchListener;

    public StayPreviewListAdapter(Context context, StayBookingDay stayBookingDay, StayDetail stayDetail//
        , PlaceReviewScores placeReviewScores//
        , StayPreviewLayout.OnEventListener onEventListener//
    ...
    private View getTitleView(View view, StayDetail stayDetail)
    {
        ...
        dateInformationLayout.setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
