...
public class InviteFriendsActivity extends BaseActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (DailyHotel.isLogin() == true && DailyTextUtils.isTextEmpty(mRecommendCode) == true)
        {
        ...
        } catch (Exception e)
        {
            showSimpleDialog(null, getString(R.string.dialog_msg_not_installed_kakaotalk)//
                ...
                , new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        Util.installPackage(InviteFriendsActivity.this, "com.kakao.talk");
                    }
                }, null);
        }
    }
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            {
                DailyTextUtils.clipText(this, mRecommendCode);
