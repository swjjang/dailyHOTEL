...
public abstract class PlacePaymentWebActivity2 extends BaseActivity implements Constants
{
    ...
    private class DailyWebViewClient extends WebViewClient
    {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl)
        {
            ...
            if (Util.isAvailableNetwork(PlacePaymentWebActivity2.this) == true)
            {
    ...
    public boolean shouldOverrideUrlLoadingForKcp(WebView view, String url)
    {
        ...
        if (url != null && !url.equals("about:blank"))
        {
            ...
            } else if (url.startsWith("tel:"))
            {
                ...
                if (Util.isTelephonyEnabled(PlacePaymentWebActivity2.this) == true)
                {
                    try
                    {
                    ...
                    {
                        DailyToast.showToast(PlacePaymentWebActivity2.this, noCallMessage, Toast.LENGTH_LONG);
                        return false;
                    }
                } else
                {
...
//                    ExLog.d("INIPAYMOBILE, 현대앱카드설치 ");
                    ...
                    if (getPackageManager().resolveActivity(intent, 0) == null)
                    {
                        ...
                        Util.installPackage(PlacePaymentWebActivity2.this, "com.hyundaicard.appcard");
                        return true;
                    }
...
//                    ExLog.d("INIPAYMOBILE, 신한카드앱설치 ");
                    ...
                    if (getPackageManager().resolveActivity(intent, 0) == null)
                    {
                        ...
                        Util.installPackage(PlacePaymentWebActivity2.this, "com.shcard.smartpay");
                        return true;
                    }
...
//                    ExLog.d("INIPAYMOBILE, 삼성카드앱설치 ");
                    ...
                    if (getPackageManager().resolveActivity(intent, 0) == null)
                    {
                        ...
                        Util.installPackage(PlacePaymentWebActivity2.this, "kr.co.samsungcard.mpocket");
                        return true;
                    }
...
//                    ExLog.d("INIPAYMOBILE, 롯데모바일결제 설치 ");
                    ...
                    if (getPackageManager().resolveActivity(intent, 0) == null)
                    {
                        ...
                        Util.installPackage(PlacePaymentWebActivity2.this, "com.lotte.lottesmartpay");
                        return true;
                    }
...
//                    ExLog.d("INIPAYMOBILE, 롯데앱카드(간편결제) 설치 ");
                    ...
                    if (getPackageManager().resolveActivity(intent, 0) == null)
                    {
                        ...
                        Util.installPackage(PlacePaymentWebActivity2.this, "com.lcacApp");
                        return true;
                    }
...
//                    ExLog.d("INIPAYMOBILE, KB앱카드 설치 ");
                    ...
                    if (getPackageManager().resolveActivity(intent, 0) == null)
                    {
                        ...
                        Util.installPackage(PlacePaymentWebActivity2.this, "com.kbcard.cxh.appcard");
                        return true;
                    }
...
//                    ExLog.d("INIPAYMOBILE, 하나SK카드 통합안심클릭앱 설치 ");
                    ...
                    if (getPackageManager().resolveActivity(intent, 0) == null)
                    {
                        ...
                        Util.installPackage(PlacePaymentWebActivity2.this, "com.ilk.visa3d");
                        return true;
                    }
...
//                    ExLog.d("INIPAYMOBILE, 현대카드 안심클릭 droidxantivirusweb:");
                    ...
                    if (getPackageManager().resolveActivity(intent, 0) == null)
                    {
                        ...
                        Util.installPackage(PlacePaymentWebActivity2.this, "net.nshc.droidxantivirus");
                        return true;
                    }
                }
