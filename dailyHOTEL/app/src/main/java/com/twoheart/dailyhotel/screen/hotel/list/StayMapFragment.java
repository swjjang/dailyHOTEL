...
public class StayMapFragment extends com.google.android.gms.maps.SupportMapFragment implements ClusterManager.OnClusterClickListener<HotelClusterItem>, ClusterManager.OnClusterItemClickListener<HotelClusterItem>
{
    ...
    private void onMarkerClick(final LatLng latlng)
    {
        ...
        if (mHotelMapViewPagerAdapter == null)
        {
            ...
            mHotelMapViewPagerAdapter.setOnUserActionListener((HotelMapFragment.OnUserActionListener) mOnInfoWindowUserActionListener);
        }
    ...
    private OnMarkerClickListener mOnMarkerClickListener = new OnMarkerClickListener()
    {
        ...
        {
            StayMapFragment.this.onMarkerClick(marker.getPosition());
