...
public class EdgeEffectColor
{
    ...
    public static void setEdgeGlowColor(RecyclerView scrollView, @ColorInt int color)
    {
        ...
        {
            Object object;
            object = RECYCLER_VIEW_FIELD_EDGE_GLOW_TOP.get(scrollView);
            setEdgeGlowColor(object, color);
            object = RECYCLER_VIEW_FIELD_EDGE_GLOW_BOTTOM.get(scrollView);
            setEdgeGlowColor(object, color);
            object = RECYCLER_VIEW_FIELD_EDGE_GLOW_LEFT.get(scrollView);
            setEdgeGlowColor(object, color);
            object = RECYCLER_VIEW_FIELD_EDGE_GLOW_RIGHT.get(scrollView);
            setEdgeGlowColor(object, color);
        } catch (Exception e)
        {
            ExLog.d(e.toString());
