...
public enum StayRoomAmenities
{
    ...
    BATHTUB(R.string.label_bathtub, R.drawable.f_ic_facilities_04, StayFilter.FLAG_HOTEL_FILTER_ROOM_AMENITIES_BATHTUB, AnalyticsManager.Label.SORTFILTER_BATHTUB),
