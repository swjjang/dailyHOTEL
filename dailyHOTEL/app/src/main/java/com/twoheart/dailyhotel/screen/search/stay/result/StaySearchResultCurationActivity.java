...
public class StaySearchResultCurationActivity extends PlaceCurationActivity implements RadioGroup.OnCheckedChangeListener
{
    ...
    protected StayCurationNetworkController mNetworkController;
