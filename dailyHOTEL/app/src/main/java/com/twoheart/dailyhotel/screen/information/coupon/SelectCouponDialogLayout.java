...
public class SelectCouponDialogLayout extends BaseLayout implements View.OnClickListener
{
    ...
    private List<Coupon> setDummyData()
    {
        ...
        list.add(new Coupon("name_3", 1000, "테스트 쿠폰_3", "2016.05.31 ~ 2016.07.31", 15, 9005300, 1, "호텔 등등 여러곳 들", ""));
        list.add(new Coupon("name_4", 111100, "테스트 쿠폰_4", "2016.04.31 ~ 2016.06.31", 15, 1000, 0, "호텔, 팬션 부띠크 등등 여러곳 들", "주의사항\n확인하기"));
        list.add(new Coupon("name_5", 500000, "테스트 쿠폰_5", "2016.05.31 ~ 2018.07.31", 15, 10, 0, " 팬션, 부띠크", "주의사항\n확인하기"));
        list.add(new Coupon("name_6", 10000, "테스트 쿠폰_6", "2010.01.01 ~ 2016.07.31", 15, 3838380, 0, "호텔, 팬션 부띠크 등등 여러곳 들", "주의사항\n확인하기"));
        list.add(new Coupon("name_7", 10340, "테스트 쿠폰_7", "2016.05.31 ~ 2016.07.31", 15, 4900, 0, "호텔, 팬션 부띠크 등등 여러곳 들", "주의사항\n확인하기"));
        ...
        list.add(new Coupon("name_12", 100303000, "테스트 쿠폰_12", "2016.05.31 ~ 2016.07.31", 15, 90440, 0, "호텔, 팬션, 부띠크 등등 여러곳 들", "주의사항\n확인하기"));
        list.add(new Coupon("name_13", 10000, "테스트 쿠폰_13", "2000.01.11 ~ 2027.07.11", 15, 20000, 0, "호텔, 팬션 부띠크 등등 여러곳 들", "주의사항\n확인하기"));
        list.add(new Coupon("name_14", 51410000, "테스트 쿠폰_14", "2016.05.31 ~ 2016.07.31", 15, 0, 1, " 팬션, 부띠크 등등 여러곳 들", ""));
        list.add(new Coupon("name_15", 810000, "테스트 쿠폰_15", "2006.09.06 ~ 2016.07.30", 15, 10, 0, "호텔, 부띠크 등등 여러곳 들", "주의사항\n확인하기"));
        list.add(new Coupon("name_16", 9504000, "테스트 쿠폰_16", "2016.05.31 ~ 2016.07.31", 15, 3000, 1, "호텔, 팬션, 부띠크 등등 여러곳 들", "주의사항\n확인하기"));
        return list;
    }
}
