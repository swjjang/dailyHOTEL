...
public class CollectionSearchGourmetListAdapter extends PlaceListAdapter
{
    private View.OnClickListener mOnClickListener;

    public CollectionSearchGourmetListAdapter(Context context, ArrayList<PlaceViewItem> arrayList, View.OnClickListener listener, View.OnClickListener eventBannerListener)
    {
