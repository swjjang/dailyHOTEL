...
{
    public static Intent newInstance(Context context, PlaceReviewScores placeReviewScore)
    {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //        List<PlaceReviewScores> placeReviewProgressList = new ArrayList<>();

        //        placeReviewProgressList.add(new PlaceReviewScores("청결", 45));
        //        placeReviewProgressList.add(new PlaceReviewScores("위치", 18));
        //        placeReviewProgressList.add(new PlaceReviewScores("서비스", 38));
        //        placeReviewProgressList.add(new PlaceReviewScores("시설", 46));
    ...
    {
        return new GourmetReviewLayout(this, new GourmetReviewLayout.OnEventListener()
        {
            @Override
            public void onTermsClick()
            {
                ...
                startActivityForResult(ReviewTermsActivity.newInstance(GourmetReviewActivity.this), Constants.CODE_REQUEST_ACTIVITY_REVIEW_TERMS);
            }

            @Override
            public void finish()
            {
                GourmetReviewActivity.this.onBackPressed();
            }
        });
    }
}
