...
public class LocationTermsActivity extends WebViewActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setWebView(DailyRemoteConfigPreference.getInstance(this).getKeyRemoteConfigStaticUrlLocation());
    ...
    private void initToolbar()
    {
        ...
        dailyToolbarView.setTitleText(R.string.actionbar_title_locationterms_activity);
