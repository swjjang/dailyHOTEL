...
public class CollectionSearchStayListAdapter extends PlaceListAdapter
{
    private View.OnClickListener mOnClickListener;

    public CollectionSearchStayListAdapter(Context context, ArrayList<PlaceViewItem> arrayList, View.OnClickListener listener, View.OnClickListener eventBannerListener)
    {
