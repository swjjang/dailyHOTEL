...
public class DailyMobileAPI implements IDailyNetwork
{
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserProfile();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserBonus();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserInformationUpdate(params);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserProfileBenefit();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserCheckEmail(userEmail);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserChangePassword(userEmail);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserInformationForPayment();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserUpdateInformationForSocial(params);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserBillingCardList();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserDeleteBillingCard(billkey);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestStaySearchAutoCompleteList(date, stays, term);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestStayRegionList();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestStayPaymentInformation(roomIndex, date, nights);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestStayDetailInformation(index, date, nights);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestStayPayment(params);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestBookingList();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetBookingDetailInformation(index);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetReceipt(index);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetHiddenBooking(index);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetAccountInformation(tid);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetRegionList();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetList(queryMap, categoryList, timeList, luxuryList);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetSearchAutoCompleteList(date, term);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetDetailInformation(index, date);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetPaymentInformation(index);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetCheckTicket(index, day, count, time);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestGourmetPayment(params);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestDepositWaitDetailInformation(tid);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestCouponList();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestCouponList(hotelIdx, roomIdx, checkIn, checkOut);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestCouponList(ticketIdx, countOfTicket);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestCouponHistoryList();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestNoticeAgreement();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestNoticeAgreementResult(isAgree);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestBenefitMessage();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestDownloadCoupon(userCouponCode);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestDownloadEventCoupon(couponCode);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestHasCoupon(placeIndex, date, nights);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestHasCoupon(placeIndex, date);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestCouponList(placeIndex, date, nights);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestCouponList(placeIndex, date);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestRegisterKeywordCoupon(keyword);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUpdateBenefitAgreement(isAgree);
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestUserTracking();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
    ...
    {
        ExecutorCallbackCall executorCallbackCall = (ExecutorCallbackCall) mDailyMobileService.requestNoticeList();
        executorCallbackCall.addQueue(tag);
        executorCallbackCall.enqueue((retrofit2.Callback<JSONObject>) listener);
